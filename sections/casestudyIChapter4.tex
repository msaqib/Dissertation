...
workload-mapping problem that we are considering in this paper.
...
We used the day-ahead prices for these locations, i.e., the electricity price negotiated for the same hour on the following day. In all the experiments for this work, we considered an operator with data centers at all 33 locations in our dataset. 
...
In this paper, we report comparative results for six workload placement algorithms.%, listed in Table~\ref{tab:algos}. 
...
While we find that RED-BL finds a useful application in electricity cost optimization of geo-diverse data centers, our work is not the final word on this problem. Several avenues of further exploration are yet to be explored. We have listed some future work in Chapter~\ref{chap:conclusions}.