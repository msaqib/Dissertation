...
\begin{figure}[t]
\centering
\includegraphics[width=1\textwidth]{pics/ilyas1.eps}
...
\begin{figure}[h!]
\centering
\includegraphics[width=1\textwidth]{pics/ilyas2.eps}
...
\begin{figure}
\centering
\includegraphics[width=1\textwidth]{pics/ilyas4a.eps}
...
\begin{figure}
\includegraphics[width=1\textwidth]{pics/ilyas4b.eps}
\label{fig:powermodel2}
\caption{Three-state power consumption model for a BTS with r TRXs. BTS power savings is applied in a more granular way, than the model of Fig.~\ref{fig:powermodel1}.}
\end{figure}
...
This proof of NP-Hardness for RED-BL, as applied to cellular networks, was done through personal communications~\cite{proofcomm}. For this proof, we define the RED-BL problem as:
\medskip
...
The pseudocode for our proposed heuristic is given in Algorithm~\ref{algo:heur1}. In the first iteration of the outer loop (lines 1 through 29), our heuristic divides the set of BTSs into two sets.
...
\SetKwFunction{Union}{Union}\SetKwFunction{FindCompress}{FindCompress}
\SetKwInOut{Input}{input}\SetKwInOut{Output}{output}
\Input{$B$ (the set of BTSs) = \{$b_1, b_2, ..., b_m$\},\\$n$ (the number of calls),\\$W$ (call association) = \{$w_{i,j} | 1 \le i \le n,$\\ \quad $1 \le j \le m$\},\\$C$ (Adjacency matrix) = \{$c_{i,j}$ = 1 if $c_i$ can \\\quad be served through $b_j$, $0$ otherwise\}}
...
\centering
\subfigure[]{
\includegraphics[width=1\textwidth]{pics/ilyas5a.eps}
\label{fig:results2}
}
\subfigure[]{
\includegraphics[width=1\textwidth]{pics/ilyas5b.eps}
\label{fig:results4}
}
...
\begin{figure}
\includegraphics[width=1\textwidth]{pics/ilyas6.eps}
...
\begin{figure}
\centering
\includegraphics[width=1\textwidth]{pics/ilyas7.eps}
