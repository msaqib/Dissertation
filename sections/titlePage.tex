...
\begin{center}
  \vspace*{0.2in}
  {\LARGE \bf RED-BL: Generalized Workload Relocation and Resource Pruning Procedure for Electricity Cost Minimization in Service Provider Networks}\\
  \vspace*{0.5in}
  {\Large \bf PhD Thesis}\\
...
\textbf{\textit{RED-BL: Generalized Workload Relocation and Resource Pruning Procedure for Electricity Cost Minimization in Service Provider Networks}} be accepted in partial fulfillment of the requirements for the degree of doctor of philosophy in computer science.
\begin{flushright}
